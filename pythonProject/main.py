...
def save_and_encrypt_notes():
    ...
    if len(title) == 0 or len(message) == 0 or len(master_secret) == 0:
        messagebox.showinfo(title="Hata!", message="Lutfen Bilgileri Dogru Giriniz")
...
title_info_lable = Label(text="Enter your title", font=FONT)
title_info_lable.pack()

title_entry = Entry(width=30)
title_entry.pack()

input_info_lable = Label(text="enter your secret", font=FONT)
input_info_lable.pack()
